...
public class SmithWaterman
{
    ...
    static public int getScore(String s1, String s2)
    {
        ...
        /*
         * Note that we would only need to keep one line, and not the full matrix, as we want to calculate the score.
         * But I'm to lazy for now. So here, h(i,j) is the maximum similarity score between suffix a[1..i] and b[1..j]
         */
        int[][] h;
    ...
    /**
     * Find the most similar str among the given set of string according to the smith waterman method.
     *
	...
	public static void main(String[] args) {
		...
		String[] a={"sadwefefew","vtrhtrjryhrt"};
		System.out.print(sw.findMostSimilar(a, "dwedewdwedwed"));
	}
}